...
const OpReportPDF = async (startDate, endDate) => {
  try {
    ...
    for (const sac of sacs) {
        ...
        const columns = {
          ...
          claimantRelationship: claimantRelationship || 'N/A', // Relación con el titular     
          fullAddress: fullAddress || 'N/A', // Domicilio suministro
          claimNumber: sac.id || 'N/A', // Número de reclamo
          claimReason: sac.claimReason || 'N/A', // Motivo reclamo
